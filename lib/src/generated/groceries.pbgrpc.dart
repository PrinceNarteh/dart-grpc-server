...
class GroceriesServiceClient extends $grpc.Client {
  ...
  static final _$deleleCategory = $grpc.ClientMethod<$0.Category, $0.Empty>(
      '/GroceriesService/deleleCategory',
      ($0.Category value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.Empty.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.Empty> deleleCategory($0.Category request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$deleleCategory, request, options: options);
  }
...
abstract class GroceriesServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.Empty> deleleCategory_Pre(
      $grpc.ServiceCall call, $async.Future<$0.Category> request) async {
    return deleleCategory(call, await request);
  }
  ...
  $async.Future<$0.Empty> deleleCategory(
      $grpc.ServiceCall call, $0.Category request);
